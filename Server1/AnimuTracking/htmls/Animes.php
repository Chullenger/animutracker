    ...
    if (this.readyState == 4 && this.status == 200) {
      ...
      for (x in myObj) {
        ...
        if(bool==true){
            ...
            txt += "<td><form id=\"sendDatas\" method=\"POST\" action=\"http://25.68.45.54:8080/AddListaAnime.php\">  <input type=\"text\" name=\"idanime\" value=\"" + myObj[x].idanime + " \" hidden=\"true\"> <input type=\"text\" name=\"idusuario\" value=\"" + myObj[x].sess +"\" hidden=\"true\"> <input type=\"Submit\" value=\"Agregar a mi lista\"> </form></td>";
        }
        txt += "</tr>";
