 ...
 */
  ...
  if($result = mysqli_query($con,$sql))
  {
    ...
    while($row = mysqli_fetch_assoc($result)) 
    {
      ...
      $sqlGEN = "SELECT g.nombre FROM manga m, genero g, m_es mes,lee l, usuario us WHERE g.idgenero=mes.genero_idgenero && mes.manga_idmanga = m.idmanga && m.idmanga={$row['idmanga']} && l.usuario_idusuario={$iduser} && us.idusuario=l.usuario_idusuario && l.manga_idmanga = m.idmanga";
